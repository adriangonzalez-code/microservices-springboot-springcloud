package com.driagon.cardsservice.app.controllers;

import com.driagon.cardsservice.app.constants.CardConstants;
import com.driagon.cardsservice.app.dto.CardDto;
import com.driagon.cardsservice.app.dto.CardsContactInfoDto;
import com.driagon.cardsservice.app.dto.ErrorResponseDto;
import com.driagon.cardsservice.app.dto.ResponseDto;
...
public class CardController {
    ...
    public ResponseEntity<CardDto> fetchCardDetails(@RequestParam
                                                     @Pattern(regexp="(^$|[0-9]{10})",message = "Mobile number must be 10 digits")
                                                     String mobileNumber) {
        log.info("Fetch Card Details REST API start");
        CardDto cardsDto = iCardsService.fetchCard(mobileNumber);
        log.info("Fetch Card Details REST API end");
    ...
    @Operation(summary = "Get Java version information", description = "Get Java versions that is installed into cards microservice")
    @ApiResponse(responseCode = "200", description = "HTTP Status OK")
    @ApiResponses({
            @ApiResponse(responseCode = "200", description = "HTTP Status OK"),
            @ApiResponse(responseCode = "500", description = "HTTP Status Internal Server Error", content = @Content(schema = @Schema(implementation = ErrorResponseDto.class)))
