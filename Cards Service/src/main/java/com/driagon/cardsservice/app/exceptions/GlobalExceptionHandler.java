package com.driagon.cardsservice.app.exceptions;
...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    public ResponseEntity<ErrorResponseDto> handleCardAlreadyException(CardAlreadyExistsException exception, WebRequest webRequest) {
