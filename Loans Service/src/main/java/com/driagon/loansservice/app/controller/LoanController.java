package com.driagon.loansservice.app.controller;

import com.driagon.loansservice.app.constants.LoansConstants;
import com.driagon.loansservice.app.dto.ErrorResponseDto;
import com.driagon.loansservice.app.dto.LoanDto;
import com.driagon.loansservice.app.dto.LoansContactInfoDto;
import com.driagon.loansservice.app.dto.ResponseDto;
...
public class LoanController {
    ...
    public ResponseEntity<LoanDto> fetchLoanDetails(@RequestParam
                                                     @Pattern(regexp="(^$|[0-9]{10})",message = "Mobile number must be 10 digits")
                                                     String mobileNumber) {
        log.info("Fetch Loan Details REST API start");
        LoanDto loansDto = iLoansService.fetchLoan(mobileNumber);
        log.info("Fetch Loan Details REST API end");
    ...
    @Operation(summary = "Get Java version information", description = "Get Java versions that is installed into loans microservice")
    @ApiResponse(responseCode = "200", description = "HTTP Status OK")
    @ApiResponses({
            @ApiResponse(responseCode = "200", description = "HTTP Status OK"),
            @ApiResponse(responseCode = "500", description = "HTTP Status Internal Server Error", content = @Content(schema = @Schema(implementation = ErrorResponseDto.class)))
